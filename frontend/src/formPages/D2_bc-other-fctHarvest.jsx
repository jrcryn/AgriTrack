      ...
      <VStack spacing={3}>
        ...
        >
          <Box bg={'purple.600'} minH={'50px'}>
            <Text textColor={'white'} fontWeight={'medium'} p={3} paddingLeft={5}>FRUIT CROPS/TREES (HARVESTING)</Text>
          </Box>
        ...
        >
            <FormControl id="firstName" isRequired>
              <FormLabel fontWeight={'semibold'} mb={5}>TOTAL NUMBER OF TREES HARVESTED (ILAN ANG KABUUANG BILANG NG PUNO NA KINUHANAN NINYO NG ANI?)</FormLabel>
        ...
        >
            <FormControl id="firstName" isRequired>
              <FormLabel fontWeight={'semibold'} mb={5}>TOTAL WEIGHT OF HARVESTED CROPS (ILAN ANG KABUUANG TIMBANG NA INYONG NAANI?)</FormLabel>
