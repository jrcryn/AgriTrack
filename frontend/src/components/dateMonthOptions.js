...
const getHarvestPeriods = () => {
  ...
  if (day <= 15) {
    // Option 1: Last two weeks of the previous month
    ...
    // Option 2: First two weeks of the next month
