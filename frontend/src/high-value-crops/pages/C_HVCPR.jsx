      ...
      <Box>
        ...
        >
          <Heading as="h2" size="md" display="flex" alignItems="center">
            <Icon as={FaFileExcel} mr={2} color="orange.600" /> HVC PRODUCTION REPORT
          </Heading>
        </Flex>
            ...
            <VStack spacing={5} align="stretch">
              ...
              <Box>
                ...
                <VStack align="start" spacing={2}>
                  <Flex align="center">
                    <Badge colorScheme="green" mr={2}>Area Planted</Badge>
                    <Text fontSize="sm">Shows the area planted on each commodity and its total quantity</Text>
                  </Flex>
                  <Flex align="center">
                    <Badge colorScheme="blue" mr={2}>Area Harvested</Badge>
                    <Text fontSize="sm">Shows the area harvested on each commodity and its total quantity</Text>
                  </Flex>
                  <Flex align="center">
                    <Badge colorScheme="purple" mr={2}>Volume of Production</Badge>
                    <Text fontSize="sm">Shows the volume of production for each commodity and its totality</Text>
                  </Flex>
                  <Flex align="center">
                    <Badge colorScheme="orange" mr={2}>Number of Farmers</Badge>
                    <Text fontSize="sm">Shows the number of farmers contributing to each commodity</Text>
                  </Flex>
                </VStack>
              </Box>
              ...
              <Text fontSize="sm" fontStyle="italic">
                The report uses the official HVC Production template format.
