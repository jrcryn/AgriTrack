...
import { register, login, checkAuth, checkPreAuth, logout, generate2FASecret, verify2FA, forgotPassword, resetPassword } from '../controller/authentication/auth.controller.js';
...
router.get('/check-pre-auth', verifyPreAuthToken, checkPreAuth);
